...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-white py-8 px-4 relative mt-36 md:mt-56">
      {/* Newsletter */}
      <div className="absolute -top-20 left-0 right-0 w-3/4 mx-auto border rounded-xl p-2 bg-base-100">
